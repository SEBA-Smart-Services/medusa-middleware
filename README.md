...
- Runs on [waitress web server](http://docs.pylonsproject.org/projects/waitress/en/latest/) web server.
...
## Installation
1. Download the [dist/Medusa Middleware-0.1-win32.msi](Windows installer).
...
### Version 0.1
 ...
 - 3rd party API credntials configurable in `config.ini`.
